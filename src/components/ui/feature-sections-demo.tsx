import { HASHMATO_SCREENSHOTS } from '@/data/hashmato'
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row items-center">
        <img
          ...
          alt="Introducing RBS by Hashmato"
        />
          ...
          <div className="flex items-center justify-center gap-6 max-w-md">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600">
                Move from scattered teams to one shared operating model.
              </p>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600">
                Standardize service quality and reduce avoidable incidents.
              </p>
            </div>
          </div>
          <div className="flex items-center justify-center gap-6 max-w-md">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600">
                Drive revenue and margin improvements with data-backed actions.
              </p>
            </div>
          </div>
        </div>
